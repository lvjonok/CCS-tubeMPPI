...
def linCovSteer(
    ...
    G0, Gu, Gw, W, D, uffvar, Kvar, Lvar = getMatrices(
        Alist, Blist, dlist, Wlist, gamma=gamma
    )
    ...
    for i in range(N + 1):
        ...
        if i < N:
            ...
            input_cov_list.append(
                CovU[i * nu : (i + 1) * nu, i * nu : (i + 1) * nu].value
            )
    datadict = {}
...
if __name__ == "__main__":
    ...
    mud = np.array([[10.0], [0.0]])

    Sigmad = np.array([[1.0, 0.0], [0.0, 1.0]])
